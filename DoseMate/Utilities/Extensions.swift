...
extension Color {
    ...
    static let appSecondary = AppColors.lavender
    static let appAccent = AppColors.mint
    static let appBackground = AppColors.background
    static let appCardBackground = AppColors.cardBackground
    
    /// 상태 색상
    static let statusSuccess = AppColors.success
    static let statusWarning = AppColors.warning
    static let statusError = AppColors.danger
    static let statusInfo = AppColors.info
}
